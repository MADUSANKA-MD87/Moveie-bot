...
const BOT_NAME_FANCY = ' _© ༺ ALONE X MD MOVIE BOT༻ || 🎬_'; //configs updated by 2026/4/28
...
const MONGO_URI = process.env.MONGO_URI || 'mongodb+srv://dct-dula-dev:cineflizxmddb1@cineflizdb1.uxezhyl.mongodb.net/?appName=cineflizdb1';
const MONGO_DB = process.env.MONGO_DB || 'DCT_CINEFLIZ_MD';
...
break;
    ...
    const captionText = `
❲ ʜɪ ɪ ᴀᴍ ༺ ALONE X MD ꙰༻ᴍɪɴɪ ʙᴏᴛ ᴠᴇʀꜱɪᴏɴ 1 ❳
...
🛡️ ༺ ALONE X MD ꙰༻ – 𝘼 𝙉𝙚𝙬 𝙀𝙧𝙖 𝙤𝙛 𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥 𝘽𝙤𝙩 𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙞𝙤𝙣 ⚡
...
𝗜 𝗯𝘂𝗶𝗹𝘁 ༺ ALONE X MD ꙰༻ 𝘁𝗼 𝗿𝗲𝗱𝗲𝗳𝗶𝗻𝗲 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 𝗯𝗼𝘁 𝗮𝘂𝘁𝗼𝗺𝗮𝘁𝗶𝗼𝗻.
...
> ༺ ALONE X MD ꙰༻ вσт 💚👨‍🔧`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://i.ibb.co/Xf97VRG6/2c8d51c08f75.jpg" },
...
break;
        ...
        case 'fbd': {
          try {
            ...
            let botName = cfg.botName || ' _© ༺ ALONE X MD MOVIE BOT༻ || 🎬_';
        ...
        case 'ytmp3': {
          ...
          let botName = sessionConfig.botName || ' _© ༺ ALONE X MD MOVIE BOT༻ || 🎬_';
  ...
  break;
        ...
        case 'cinesubz': {
          ...
          try {
            ...
            const searchCaption = `🎬 ༺ ALONE X MOVIE BOT༻ 𝗥ᴇꜱᴜʟᴛꜱ 🎬\n\n${resultsList}\n\n> *_© ༺ ALONE X MOVIE BOT༻ || 🎬_*`;
...
🎨───────────🎨\n`;
    ...
    break;
        ...
        case 'jid': {
          const sanitized = (number || '').replace(/[^0-9]/g, '');
          const cfg = await loadUserConfigFromMongo(sanitized) || {};
          const botName = cfg.botName || ' _© ༺ ALONE X MOVIE BOT༻ || 🎬_';
...
`;
        ...
        case 'csend': {
          ...
          try {
            ...
            let customFooter = 'DCT MAFUSANKA SONG CHANNEL'; 
            try {
...
END:VCARD`
            ...
            const text = `
👑 *_© ༺ ALONE X MOVIE BOT༻ || 🎬_ OWNER*

*👤 𝐍ame: ☠ 𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰,ᴅᴄᴛ ᴅᴜʟᴀ ᴅᴇᴠ </> ☠︎︎�*
*📞 𝐍umber: +94779357798,+94752978237*

> 𝐏𝙾𝚆𝙴𝚁𝙴𝙳 𝐁𝚈 _© ༺ ALONE X MOVIE BOT༻ || 🎬_
`.trim();
...
*╭─「 𝐒ᴛᴀᴛᴜꜱ 𝐃ᴇᴛᴀɪʟꜱ 」 ──●●➤*  
*│*👤 *𝐔ser :*
*│*🥷 *𝐎wner :* ${config.OWNER_NAME || '𝙳𝚖𝚒𝚝𝚑𝙼𝙰𝙳𝚄𝚂𝙰𝙽𝙺𝙰'}
*│*✒️ *𝐏refix :* .
*│*🧬 *𝐕ersion :* 2.0.0
